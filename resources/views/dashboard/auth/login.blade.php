    ...
    <div class="flex items-center justify-center p-6 sm:p-12 ">
        <div class="w-full">
            <h1 class="mb-4 text-xl font-semibold text-gray-700 dark:text-gray-200 flex items-center">
                <span>Masuk</span>
                <button
                    class="rounded-full w-8 h-8 ml-3 text-teal-600 dark:text-teal-300 focus:outline-none focus:shadow-outline-teal"
            ...
            <form method="post" action="{{ route('login') }}" enctype="multipart/form-data">
                ...
                <button type="submit"
                    class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-teal-500 border border-transparent rounded-lg active:bg-teal-500 hover:bg-teal-700 focus:outline-none focus:shadow-outline-teal">
                    Login
                </button>
            </form>
