...
@section('container')
    <div class="flex flex-col overflow-y-auto md:flex-row">
        <div class="h-32 md:h-auto md:w-1/2 !p-5" style="padding: 20px !important;">
            <img aria-hidden="true" class=" !p-5 w-full h-full dark:hidden object-cover" src="{{ asset('img/Logo Man.jpg') }}" alt="Office">
            <img aria-hidden="true" class="hidden !p-5 w-full h-full dark:block object-cover" src="{{ asset('img/Logo Man.jpg') }}" alt="Office">
        </div>
