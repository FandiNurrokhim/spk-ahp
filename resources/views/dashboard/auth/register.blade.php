...
@section('container')
    <div class="flex flex-col overflow-y-auto md:flex-row">
        <div class="h-full md:h-auto md:w-1/2 !p-5" style="padding: 20px !important;">
            <img aria-hidden="true" class="w-full h-auto !p-5  dark:hidden object-cover" src="{{ asset('img/Logo Man.jpg') }}" alt="Office">
            <img aria-hidden="true" class="w-full h-auto hidden !p-5 dark:block object-cover" src="{{ asset('img/Logo Man.jpg') }}" alt="Office">
        </div>
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
                <h1 class="mb-4 text-xl font-semibold text-gray-700 dark:text-gray-200 flex items-center">
                    <span>Register</span>
                    <button class="rounded-full w-8 h-8 ml-3 focus:outline-none focus:shadow-outline-purple"
