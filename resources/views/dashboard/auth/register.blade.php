...
@section('container')
    <div class="flex flex-col overflow-y-auto md:flex-row">
        <div class="h-full md:h-auto md:w-1/2 !p-5" style="padding: 20px !important;">
            <img aria-hidden="true" class="w-full h-auto !p-5  dark:hidden" src="{{ asset('img/Logo Man.jpg') }}" alt="Office">
            <img aria-hidden="true" class="w-full h-auto hidden !p-5 dark:block" src="{{ asset('img/Logo Man.jpg') }}" alt="Office">
        </div>
