<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    <div class="container flex items-center justify-end h-full px-6 mx-auto text-teal-600 dark:text-teal-300">
        <!-- Mobile hamburger -->
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="flex justify-center items-center">
                <button class="rounded-full w-8 h-8 focus:outline-none focus:shadow-outline-purple" @click="toggleTheme"
            ...
            <li class="relative">
                <div class="dropdown dropdown-end">
                    <label tabindex="0"
                        class="btn btn-ghost btn-circle hover:bg-teal-100 dark:hover:bg-teal-900 m-1">
                        <i class="ri-user-3-fill text-xl text-teal-600 dark:text-teal-300"></i>
                    </label>
                    <ul tabindex="0"
                        class="dropdown-content z-[1] menu p-2 shadow bg-white dark:bg-gray-800 rounded-box w-52 border border-gray-200 dark:border-gray-700">
                        <li class="flex">
                            <a class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-gray-200"
                                href="{{ route('profile') }}">
                                <i class="ri-user-line text-base mr-3 text-teal-600 dark:text-teal-300"></i>
                                <span class="text-gray-800 dark:text-gray-200">Profile</span>
                            </a>
                        </li>
                        <li class="flex">
                            <form action="{{ route('logout') }}" method="post" enctype="multipart/form-data"
                                class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-gray-200">
                                @csrf
                                <button type="submit" class="inline-flex items-center w-full text-left">
                                    <i class="ri-logout-box-line text-base mr-3 text-teal-600 dark:text-teal-300"></i>
                                    <span class="text-gray-800 dark:text-gray-200">Log out</span>
                                </button>
                            </form>
                        </li>
                    </ul>
