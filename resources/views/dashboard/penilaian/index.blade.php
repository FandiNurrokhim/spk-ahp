            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                    ...
                    <div class="flex space-x-3">
                        <div class="flex space-x-3 items-center">
                            ...
                            <form action="{{ route('penilaian.pdf_ahp') }}" method="post" enctype="multipart/form-data"
                                ...
                                @csrf
                                <button type="submit"
                                    class="btn text-white dark:text-gray-800 normal-case bg-rose-600 hover:bg-rose-600 hover:bg-opacity-70 hover:border-opacity-70 dark:bg-rose-300 dark:hover:bg-rose-300 dark:hover:bg-opacity-90 dark:border-rose-300">
                ...
                <div class="mb-7 bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="overflow-x-auto p-3">
                        <table id="tabel_data_alternatif"
                                ...
                                @foreach ($data->unique('alternatif_id') as $item)
                                    <tr class="border-b dark:border-gray-700">
                                        <td class="px-4 py-3 text-gray-700 dark:text-gray-400 uppercase font-semibold">
                                            ...
                                            <a href="{{ route('penilaian.ubah', ['alternatif_id' => $item->alternatif_id]) }}"
