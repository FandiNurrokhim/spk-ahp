            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="mb-7 bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex justify-between items-center p-4 mb-5">
                        <div class="flex space-x-3">
                            <div class="flex space-x-3 items-center">
                                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200">1. Bobot Relatif Kriteria (wj)</h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                <tr>
                                    @foreach ($kriteria as $item)
                                        <th scope="col" class="px-4 py-3">{{ $item->kode ?? 'C'.$loop->iteration }}</th>
                                    @endforeach
                ...
                <div class="mb-7 bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex justify-between items-center p-4 mb-5">
                        <div class="flex space-x-3">
                            <div class="flex space-x-3 items-center">
                                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200">2. Matriks Perbandingan Alternatif dan Kriteria</h2>
                            </div>
                        </div>
                    </div>
                    <div class="overflow-x-auto p-3">
                ...
                <div class="mb-7 bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex justify-between items-center p-4 mb-5">
                        <div class="flex space-x-3">
                            <div class="flex space-x-3 items-center">
                                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200">3. Pangkat (wj untuk Cost = negatif)</h2>
                            </div>
                        </div>
                    </div>
                    <div class="overflow-x-auto p-3">
                ...
                <div class="mb-7 bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex justify-between items-center p-4 mb-5">
                        <div class="flex space-x-3">
                            <div class="flex space-x-3 items-center">
                                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200">4. Perhitungan Nilai Vektor S</h2>
                            </div>
                        </div>
                    </div>
                    <div class="overflow-x-auto p-3">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @foreach ($alternatif as $alt)
                                    <tr class="border-b dark:border-gray-700">
                                        <td class="px-4 py-3 font-semibold">{{ $alt->kode ?? 'A'.$loop->iteration }}</td>
                                        <td class="px-4 py-3">{{ isset($nilaiS[$alt->id]) ? number_format($nilaiS[$alt->id], 9) : '0' }}</td>
                                    </tr>
                                @endforeach
                ...
                <div class="mb-7 bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex justify-between items-center p-4 mb-5">
                        <div class="flex space-x-3">
                            <div class="flex space-x-3 items-center">
                                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200">5. Perhitungan Nilai Preferensi Relatif (Vektor V)</h2>
                            </div>
                        </div>
                    </div>
                    <div class="overflow-x-auto p-3">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @foreach ($alternatif as $alt)
                                    <tr class="border-b dark:border-gray-700">
                                        <td class="px-4 py-3 font-semibold">{{ $alt->kode ?? 'A'.$loop->iteration }}</td>
                                        <td class="px-4 py-3">{{ isset($nilaiV[$alt->id]) ? number_format($nilaiV[$alt->id], 9) : '0' }}</td>
                                    </tr>
                                @endforeach
                                <tr class="bg-blue-50 font-bold">
                                    <td class="px-4 py-3">Jumlah</td>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                @foreach ($sortedAlternatif as $alt)
                                    <tr class="border-b dark:border-gray-700 {{ isset($ranking[$alt->id]) && $ranking[$alt->id] == 1 ? 'bg-green-50' : '' }}">
                                        <td class="px-4 py-3 font-semibold">{{ $alt->kode ?? 'A'.$loop->iteration }}</td>
                                        ...
                                        <td class="px-4 py-3">
                                            @if(isset($ranking[$alt->id]))
                                                <span class="px-2 py-1 text-sm font-semibold rounded-full 
                                                    {{ $ranking[$alt->id] == 1 ? 'bg-green-100 text-green-800' : 
                                                       ($ranking[$alt->id] == 2 ? 'bg-blue-100 text-blue-800' : 
